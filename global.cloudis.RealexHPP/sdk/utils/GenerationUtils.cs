...
namespace global.cloudis.RealexHPP.sdk.utils
{
    public class GenerationUtils
    {
        ...
        public static string GenerateHash(string toHash, string secret)
        {
            ...
            {
                byte[] hashFirstPass = sha1.ComputeHash(Encoding.UTF8.GetBytes(toHash));
                StringBuilder sbHashFirstPass = new StringBuilder((hashFirstPass.Length * 2));
                ...
                string toHashSecondPass = sbHashFirstPass.ToString() + "." + secret;

                byte[] hashSecondPass = sha1.ComputeHash(Encoding.UTF8.GetBytes(toHashSecondPass));
                StringBuilder sbToHashSecondPass = new StringBuilder((hashSecondPass.Length * 2));
